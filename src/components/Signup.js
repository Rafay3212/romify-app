                            ...
                            <form className="flex flex-col mt-10 w-full max-md:max-w-full">
                                <div className="mb-6">
                                    ...
                                    <input
                                        type="text"
                                        id="name"
                                        className="flex-1 shrink gap-3 py-3 pr-3 pl-7 max-w-full text-base font-medium tracking-normal rounded-3xl border border-black border-solid min-h-[44px] text-gray-950 text-opacity-30 w-[471px] max-md:pl-5 max-md:max-w-full"
